...
echo "🎨 Generating Rival Character sprite..."
...
if 'images' in data:
    ...
    print(f'\n🎉 Generated {len(data[\"images\"])} Rival Character sprites!')
    print(f'📂 Check $OUTPUT_DIR/rival-*.png')
else:
...
echo ""
echo "🔍 Review sprites and pick the best one to use as rival-front.png"
